...
f_4 <- y ~ -1 + b0 + x_bar +
  ...
  f(inla.group(x_bar_c_s, n = 100, method = "cut"), model = 'rw2', scale.model = T, hyper = list(theta = list(prior = "pc.prec", param = c(150, 0.01)))) +
  f(inla.group(x_bar_c_s_m, n = 100, method = "cut"), model = 'rw2', scale.model = T, hyper = list(theta = list(prior = "pc.prec", param = c(80, 0.01)))) +
  f(inla.group(x_res_smy, n = 100, method = "cut"), model = 'rw2', scale.model = T, hyper = list(theta = list(prior = "pc.prec", param = c(50, 0.01))))
